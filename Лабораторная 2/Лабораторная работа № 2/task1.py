...
class Book:
    def __init__(self, id_: int, name: str, pages: int):
        ...
        if id_ < 0:
            raise ValueError("Идентификатор книги не должен быть отрицательным числом")
        self.id_ = id_  # id зарезервированное слово в Python, поэтому используем id_ + в задании п.3 представлен пример
